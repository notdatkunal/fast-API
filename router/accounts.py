...
#    account_instance = models.Account # asigning the Model
...
#    todo_model = db.query(models.Account).all()
...
#    if db.query(models.Institute).filter(models.Institute.id == institute_id).first():
#       todo_model = db.query(models.Account).filter(models.Account.institute_id == institute_id).all()
#       return jsonable_encoder(todo_model)
...
#    account_data = db.query(models.Account).filter(models.Account.id == account_id).first()
